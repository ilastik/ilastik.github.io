...
**Release Highlights:**
  ...
  * New object features based on Spherical Harmonics Feature Extraction contributed by contributed by Aafke Gros ([publication](https://dx.plos.org/10.1371/journal.pcbi.1012349)).
  * Native support for Apple Silicon (M1, M2, M3, M4)


**New Contributors for this release**:
  * [Aafke Gros](https://github.com/aafkegros)
